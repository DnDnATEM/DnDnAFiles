...
if not DevAli:get(DnDnA..'Ali:Lock:Reply'..msg.chat_id_) then
...
DnDnATEAM =  "آخلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == 'السلام عليكم' or text == 'سلام عليكم' then 
DnDnATEAM =  "ياھَہّلْاا ۅﻋ̝̚لْيڪْم الْﺳ̭͠ لْام 𖠙 🤤♥️"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == '😭💔' or text == '😭😭' or text == '😭😭😭' or text == '😿💔' or text == '😭😭😭' or text == '😭😭😭😭' then 
DnDnATEAM =  "مآآعٍآشُ آلُِي يزعٍلُِڪڪ 𖠙 😏♥️"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == '🌚💔' or text == '💔🌚' or text == '🚶‍♂💔' or text == '💔' or text == '😔💔' or text == '🚶‍♀💔' or text == '😭' then 
DnDnATEAM =  "شبّيي اﻟ̣̣פﻟ̣̣و 𖠙 😿💔"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == 'باي' or text == 'بااي' or text == 'اروح' or text == 'اروح احسن' or text == 'اولي احسن' or text == 'راح اروح' or text == 'باي انام' then 
DnDnATEAM =  "أُرٌجُعُ عٍيدِهآآ مٍوو تنِْسةه 𖠙 🤤♥️"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == 'هلو' or text == 'هلاو' or text == 'هلا' or text == 'هلاوو' or text == 'هيلاو' or text == 'هيلاوو' or text == 'هلاا' then 
local DnDnATEAM = {"اࠗط็لق֯ق֯ هٞللاࠗ୨و 𖠙 🤤♥️" ,"هۂَلاا نۨہٰورتت يعمۘري 𖠙 🤤♥️" } 
DevAli2 = math.random(#DnDnATEAM) 
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM[DevAli2] , 1, 'md') 
return false
end
...
local DnDnATEAM = {"ماﺷ͠ يةھَہّ يﻋ̝̚مريي ۅاﻧﺗ̲ت 𖠙 🤤♥️" ,"الحۡمۘدللهۂَ ٰوانۨہتت 𖠙 🤤♥️","تمۘامۘ عمۘري ٰوانۨہتت 𖠙 🤤♥️"} 
DevAli2 = math.random(#DnDnATEAM) 
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM[DevAli2] , 1, 'md') 
return false
end
if text == 'وينك' or text == 'وينج' then
DnDnATEAM =  "مْوٌجہوٌدِ يہمْگُ يحلوُ 𖠙 😉♥️"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == 'بوت عواي' or text == 'بوت زربه' or text == 'البوت عاوي' or text == 'البوت زربه' then
DnDnATEAM =  "اطردكك تجرب ؟ ، 😕🔪"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == 'نايمين' or text == 'ميتين' then
DnDnATEAM =  "طُآمسين ووعٍيوونڪ 𖠙 😪🖤ۦ"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == 'هلوباي' or text == 'هلو باي' then  
DnDnATEAM =  "شحۡسۜيت مۘنۨہ هيجۚ ּكتبت ؟ 🌝♥️"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
if text == 'اكلك' or text == 'اكلج' or text == 'اكلكم' then 
DnDnATEAM =  "ڪوولُِ مآڪوولُِ لُِآحٍدِ 𖠙 😉♥️"
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md')
return false
end
if text == 'فرخ' or text == 'فرخه' then
DnDnATEAM =  "ٰوينۨہهۂَ خۡل احۡصرهۂَ 𖠙 😹♥️" 
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md') 
return false
end
...
DnDnATEAM =  "لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪" 
Dev_Ali(msg.chat_id_, msg.id_, 1, DnDnATEAM, 1, 'md')
return false
end
end
...
DevAli:del(DnDnA..'Ali:Lock:Reply'..msg.chat_id_)
end end
if text == 'تعطيل ردود البوت' or text == 'تعطيل الردود' then
if DevAli:get(DnDnA..'Ali:Lock:Reply'..msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد معطله ', 1, 'md')
else
DevAli:set(DnDnA..'Ali:Lock:Reply'..msg.chat_id_,true)

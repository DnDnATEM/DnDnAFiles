...
if DevAli:get(DnDnA.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(DnDnA.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(DnDnA.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DnDnAName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DnDnAName then 
DnDnANames = DevAli:smembers(DnDnA.."Ali:Mute:Names"..msg.chat_id_) or ""
if DnDnANames and DnDnANames[1] then 
for i=1,#DnDnANames do 
if DnDnAName:match("(.*)("..DnDnANames[i]..")(.*)") then 
...
DevAli:set(DnDnA.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(DnDnA.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end

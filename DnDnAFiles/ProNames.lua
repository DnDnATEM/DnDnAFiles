...
DevAli:set(DnDnA.."Ali:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAli:get(DnDnA.."Ali:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAli:get(DnDnA.."Ali:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAli:get(DnDnA.."Ali:ProNames:Num"..msg.chat_id_) or 5
...
if DevAli:get(DnDnA.."Ali:Lock:ProNames"..msg.chat_id_) and DevAli:get(DnDnA.."Ali:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAli:get(DnDnA.."Ali:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAli:srem(DnDnA..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAli:get(DnDnA.."Ali:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAli:get(DnDnA.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevAli:sadd(DnDnA..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevAli:del(DnDnA.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAli:set(DnDnA.."Ali:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAli:del(DnDnA.."Ali:Lock:ProNames"..msg.chat_id_)
end
end
